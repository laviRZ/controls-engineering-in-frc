...
\definecolor{coverbluex}{RGB}{255,107,166}
\colorlet{themecolorx}{coverbluex}
    ...
    \begin{tikzpicture}[remember picture,overlay]%
      \node at (current page.north west){%
        \begin{tikzpicture}[remember picture,overlay]%
          ...
          \node[anchor=north] at (6cm,-3.25cm){%
